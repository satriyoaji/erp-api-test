...
describe("update supplier group", () => {
  let _id = "";
  beforeEach(async () => {
    ...
    // send request to update supplier group
    const data = {
      name: "Group A",
    };
  ...
  it("should save to database", async () => {
    ...
    const supplierGroupService = new supplierGroupService(db);
    const result = supplierGroupService.read(response.body._id);
